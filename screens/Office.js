...
class OfficeEvent extends React.Component {

    constructor(props) {
        super(props);
        this.state = {
            out1: "",
            chosenDate: new Date(), selectedHours: 12,createdBy:global.ID,
            selectedMinutes: 12,selectedHours2:10,selectedMinutes2:10, textValue: 'Event Address', text: "", text1: "", text2: "", text3: "", text4: '',textValue1: "Description"
        };
    ...
    change = () => {                                                          ///Form validation
        ...
        if (this.state.text4.trim() === "") {
         ...
         if(this.state.text1=='' && this.state.text2 =='' && this.state.text3 =='' && this.state.text4 ==''){
            ...
            axios.post('http://192.168.43.136:3000/events/office/',this.state,{
            headers: {
        ...
        return (
            ...
            <Container>
                <Header>
                    ...
                    <Body>
                        <Text style={{color:'white',fontSize:20,fontWeight:'bold',left:-60}}>office party</Text>
                    </Body>
                            ...
                            <View style={{ flexDirection: "row", left: 7, top: 4 }}>
                                <View style={{ flex: 1 }}>
                                    <Item floatingLabel style={{ justifyContent: 'flex-start', width: 160 }}  >
                                        <Label style={{ opacity: 0.7 }}>Event Name*</Label>
