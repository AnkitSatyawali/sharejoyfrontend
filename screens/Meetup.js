...
class MeetupEvent extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            out1: "",createdBy:global.ID,
            chosenDate: new Date()/*date*/, selectedHours: 12,
            selectedMinutes: 12,selectedHours2:10,selectedMinutes2:10,textValue: 'Event Address',text5:"", text: ""/*name*/, text1: "", text2: "", text3: "", text4: '',textValue1: "Description"
        };
    ...
    change = () => {                                                          ///Form validation
        ...
        if(this.state.text1=='' && this.state.text2 =='' && this.state.text3 =='' && this.state.text4 ==''){
            ...
            axios.post('http://192.168.43.136:3000/events/meetup/',this.state,{
            headers: {
                    ...
                    <Form rounded>
                        <View style={styles.col}>
                            ...
                            <Item floatingLabel style={{ justifyContent: 'flex-start', width: 160 }}  >
                                        ...
                                        <Input onChangeText={text5 => this.setState({ text5 })} value={this.state.text5} />
