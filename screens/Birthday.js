...
import { Container, Header, Content, Form, Item, Input, Label, View, DatePicker, Icon, Picker, Button, Left, Body, Right, Title, Toast } from 'native-base';
...
class BirthdayEvent extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            createdBy:global.ID,
            output: "",
            chosenDate: new Date(),selectedHours: 12,
            selectedMinutes: 12, selectedHours2 : 12 , selectedMinutes2:12, textValue: 'Event Address', text: "", text1: "", text2: "", text3: "", text4: '',textValue1: "Description"
        };
    ...
    change = () => {                                                          ///Form validation
        ...
        if(this.state.text1=='' && this.state.text2 =='' && this.state.text3 =='' && this.state.text4 ==''){
            ...
            axios.post('http://192.168.43.136:3000/events/birthday/',this.state,{
            headers: {
        ...
        return (
            ...
            <Container>
                <Header>
                    ...
                    <Body>
                        <Text style={{color:'white',fontSize:20,fontWeight:'bold',left:-60}}>Birthday Event</Text>
                    </Body>
                ...
                <Content>
                    <Form rounded>
                        <View style={styles.col}>
                                ...
                                <View style={{ flex: 1 }}>
                                    ...
                                    <Item style={{ justifyContent: 'flex-start', width: 170 }}>
                                        ...
                                        <TimePicker
                                            ...
                                            startingHours={selectedHours}
                                            startingMinutes={selectedMinutes}
                            ...
                            <Item floatingLabel style={{ top: -10 }}  >
                                <Label >{this.state.textValue1}</Label>
