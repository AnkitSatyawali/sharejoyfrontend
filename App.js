...
class AuthLoadingScreen extends React.Component{
 ...
 const isLoggedIn=await AsyncStorage.getItem('isLoggedIn'); // to check if anykind of data is stored in asyncstorage
   ...
   if(AlreadyLoaded !=='1'){
    ...
    this.props.navigation.navigate(isLoggedIn !=='1' ? 'Auth':'HomeScreen',{text:value,photoUrl:photo}); //if isLoggedin != 1 redirect to Auth(ie LoginScreen) else if isLoggdin =1 redirect to homescreen  
   }
